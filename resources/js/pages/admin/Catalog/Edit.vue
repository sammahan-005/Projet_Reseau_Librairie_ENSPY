...
const form = useForm({ title: book.title || '', author: book.author || '', published_year: book.published_year || '', cover_image: null, pdf: null });
...
function submit() {
  form.put(`/admin/api/books/${book.id}`, { forceFormData: true });
}
</script>
